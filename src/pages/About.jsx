          ...
          <div className="max-w-7xl mx-4 lg:mx-12 flex items-center">
            ...
            <div className="overflow-hidden w-full">
              <div className="whitespace-nowrap animate-marquee text-gray-300 text-md lg:text-lg py-3 lg:py-5 px-4 lg:px-6">
                Our goal is to be your trusted partner, ensuring every project
                is on time, user-first, and built for success.
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mt-6">
              Thoughtful design, modern tech, and measurable results — all in
              one place.
            </p>
          </div>
          ...
          <motion.div
            ...
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-7 items-start"
          >
            {/* CARD 1 */}
            <motion.div
              variants={{
            ...
            >
              <div className="relative overflow-hidden rounded-[30px] bg-white/5 border border-white/10 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
                ...
                <div className="absolute bottom-0 left-0 p-6">
                  ...
                  <h3 className="text-2xl font-semibold text-white">Tushar</h3>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative overflow-hidden rounded-[30px] bg-white/5 border border-white/10 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
                ...
                <div className="absolute bottom-0 left-0 p-6">
                  ...
                  <h3 className="text-2xl font-semibold text-white">Gurleen</h3>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative overflow-hidden rounded-[30px] bg-white/5 border border-white/10 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
                ...
                <div className="absolute bottom-0 left-0 p-6">
                  ...
                  <h3 className="text-2xl font-semibold text-white">Priyesh</h3>
                </div>
              </div>
            </motion.div>
