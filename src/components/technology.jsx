    ...
    <AnimatedSection>
      <section className="relative py-16 md:py-10 overflow-hidden">
        ...
        <motion.div
          ...
          className="text-center text-white mb-10 md:mb-14 px-4"
        >
          ...
          <h2 className="text-base sm:text-lg md:text-2xl font-light mb-4 max-w-4xl mx-auto leading-relaxed">
            We use up to date tools and technologies to build fast, reliable and future proof products.
          </h2>
        </motion.div>
        ...
        <motion.div
          ...
          className="md:max-w-350 mx-auto bg-white rounded-3xl md:rounded-[2.5rem] 
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="flex items-center justify-center min-w-max px-6 sm:px-10"
            >
