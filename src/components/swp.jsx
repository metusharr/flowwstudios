      ...
      <section className="relative py-16 md:py-20 lg:py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          ...
          <motion.p
            ...
            transition={{ duration: 0.6 }}
            className="text-purple-400 text-center font-semibold text-xl sm:text-2xl md:text-2xl mb-6"
          >
            Services we provide
          </motion.p>
          ...
          <motion.h2
            ...
            className="text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light leading-tight mb-4 md:mb-6 px-2"
          >
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="text-center text-gray-300 text-sm sm:text-base md:text-lg max-w-3xl mx-auto mb-12 md:mb-16 px-2"
          >
